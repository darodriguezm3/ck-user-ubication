...
1. **Descripción general** de la API y características.
2. **Instrucciones de configuración** para correr la API localmente y en Docker.
3. **Despliegue en Back4App**, incluyendo la configuración del repositorio y variables de entorno.
4. **Documentación de los endpoints** y ejemplos de uso.
5. **Script SQL** para los **Stored Procedures** en PostgreSQL.
